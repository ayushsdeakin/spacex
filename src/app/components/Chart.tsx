...
export const Chart = () => (
  ...
  >
    <div className={'absolute p-4 dark:text-neutral-100 text-neutral-100'}>
      <div className={'font-medium'}>This Month:</div>
      <div className={'font-bold text-3xl'}>+300%</div>
    </div>
    <div className={'dark:bg-neutral-950 bg-neutral-900 dark:bg-grid-neutral-700 bg-grid-neutral-200'}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 653 465">
        <motion.path
          ...
          className={'dark:fill-green-800 fill-green-400'}
        />
        <motion.path
          ...
          fill="none"
          className={'dark:stroke-green-400 stroke-green-400'}
          strokeWidth="4"
        />
      </svg>
    </div>
